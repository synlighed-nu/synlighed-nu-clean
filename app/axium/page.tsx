    ...
    <div className="min-h-screen bg-white text-[#002B5B] pt-28 pb-20">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <a href="https://www.dst.dk/da/Statistik/emner/sociale-forhold/social-stoette/boligstoette" target="_blank" className="group bg-white border border-gray-200 hover:border-[#002B5B] rounded-3xl p-8 transition-all">
          ...
          <a href="https://ens.dk/" target="_blank" className="group bg-white border border-gray-200 hover:border-[#002B5B] rounded-3xl p-8 transition-all">
            ...
            <div className="text-[#002B5B] font-medium flex items-center gap-2">Energistyrelsen <span className="text-xl">↗</span></div>
          </a>

          {/* NY KORREKT SUNDHEDS-LINK */}
          <a href="https://www.sst.dk/vidensbase/forebyggelse/forebyggelsespakker-og-undersoegelser/forebyggelses-pakker-til-kommunerne" target="_blank" className="group bg-white border border-gray-200 hover:border-[#002B5B] rounded-3xl p-8 transition-all">
            <h3 className="font-semibold text-2xl mb-3">Sundhed</h3>
            <p className="text-gray-600 mb-6">280 mia. kr. årligt. Stort fokus på medicin og behandling – meget lidt på reel forebyggelse.</p>
          ...
          <a href="https://www.geus.dk/" target="_blank" className="group bg-white border border-gray-200 hover:border-[#002B5B] rounded-3xl p-8 transition-all">
            ...
            <div className="text-[#002B5B] font-medium flex items-center gap-2">GEUS – Geologisk Undersøgelse <span className="text-xl">↗</span></div>
          </a>

          <a href="https://uibm.dk/" target="_blank" className="group bg-white border border-gray-200 hover:border-[#002B5B] rounded-3xl p-8 transition-all">
          ...
          <a href="https://rigsrevisionen.dk/" target="_blank" className="group bg-white border border-gray-200 hover:border-[#002B5B] rounded-3xl p-8 transition-all">
